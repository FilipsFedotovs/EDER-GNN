...
class HitCluster:
      ...
      def GenerateTrainData(self, MCHits, fraction,cut_dt, cut_dr): #Decorate hit information
           ...
           Genuine = Genuine.drop(['d_tx','d_ty','d_x','d_y','join_key','r_x','r_y','r_z','l_x','l_y','l_z','l_tx','l_ty','r_tx','r_ty'],axis=1)
           Fakes = Fakes.drop(['d_tx','d_ty','d_x','d_y','join_key','r_x','r_y','r_z','l_x','l_y','l_z','l_tx','l_ty','r_tx','r_ty'],axis=1)
           print(Fakes)
           print(Genuine)
           exit()

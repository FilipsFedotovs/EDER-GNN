...
class bcolors:
    ...
    BOLD = '\033[1m'
    UNDERLINE = '\033[4m'
parser = argparse.ArgumentParser(description='This script prepares the MC tracking data for EDER-GNN desegmentation evaluation routines')
...
print(bcolors.HEADER+"####################  Initialising EDER-TSU evaluation data preparation module      ###################"+bcolors.ENDC)

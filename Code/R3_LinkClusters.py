...
if Mode=='R':
   ...
   if UserAnswer=='Y':
      ...
      for k in range(0,Zsteps):
            ...
            MSGName = AFS_DIR + '/HTCondor/MSG/MSG_R3_' + str(k)
            ScriptName = AFS_DIR + '/Code/Utilities/R3_LinkClusters_Sub.py '
            UF.SubmitJobs2Condor([OptionHeader, OptionLine, SHName, SUBName, MSGName, ScriptName, Xsteps, 'EDER-GNN-R3', True,False])
